...
export function defaultSettings(): AppSettings {
  return {
    ...
    tachoTextColor: c(1, 1, 1),
    tachoTextSize: 0,
    tachoTextShadowEnabled: true,
    tachoTextShadowColor: c(0, 0, 0, 0.9),
    tachoTextShadowOffsetX: 2,
    tachoTextShadowOffsetY: 2,
    tachoTextShadowBlur: 0,
    tachoTextOutlineEnabled: true,
    tachoTextOutlineColor: c(0, 0, 0, 0.85),
    tachoTextOutlineSize: 1,
